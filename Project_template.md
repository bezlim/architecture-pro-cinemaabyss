...
[schemas/target-architecture.puml](schemas/target-architecture.puml)

![To-Be Architecture](assets/images/to-be.png)
...
Это тест уже после всей настройки, потерял скрин :)
![Скриншот логов сервиса](assets/images/events.png)
...
Скрин развёртывания
![helm](assets/images/helm.png)

Скрин с фильмами
![helm](assets/images/movies.png)
...
![Скрин fortio](assets/images/fortio.png)
